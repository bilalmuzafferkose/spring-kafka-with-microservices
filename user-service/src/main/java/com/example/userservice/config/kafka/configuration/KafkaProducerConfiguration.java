...
public class KafkaProducerConfiguration {
    ...
    //Kafka brokerların tanımlanması
    @Value("${kafka.host}") //application.yml kafka.host
    private String kafkaBrokers; //kafka producer'ın bind olacağı host bilgisidir. birden fazla host bilgisi verebiliyoruz
